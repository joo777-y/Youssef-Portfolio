...
export const projects: Project[] = [
    {
      ...
      {
        title: 'Italy Tour Website',
        description: ' Developed a fully-structured tourism website with navbars, sections, and contact forms using semantic HTML and clean CSS code.',
        technologies: ['HTML5', 'CSS3'],
        githubLink: 'https://github.com/joo777-y/HTML5-CSS3.git',
        demoLink: 'https://joo777-y.github.io/HTML5-CSS3/',
        image: '/projects/project2.png',
      },
      {
        title: 'Safaris in Africa Website',
        description: ' Built a responsive web layout for a business template using Bootstrap’s grid system and components.',
        technologies: ['HTML5', 'CSS3', 'Bootstrap'],
        githubLink: 'https://github.com/joo777-y/Responsive.git',
        demoLink: 'https://joo777-y.github.io/Responsive/',
