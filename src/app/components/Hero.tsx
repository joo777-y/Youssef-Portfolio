        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <Image
              ...
              width={250}
              height={250}
              className="rounded-full mb-4 w-42 h-42 object-cover ring-2 ring-primary"
            />
          </motion.div>
          <motion.h1
              ...
              >
                ...
                >
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-block w-full bg-primary text-white px-8 py-3 rounded-lg hover:bg-primary/90 transition-colors"
                  >
                    View My CV
                  </a>
                </motion.div>
